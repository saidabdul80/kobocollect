...
function ngaddEvent(id, relationId) {
    var _obj = jQuery("#" + id);
    var arr = id.split("");
    var _Textobj = jQuery("#" + id + "," + "#nis" + arr.slice(4).join(""));
    ...
    if (ngjsconfig[id].active === !0) {
        ...
        _Textobj.hover(function() {
            jQuery("#jstip").show().html(ngjsconfig[id].hover);
            _obj.css({
...
jQuery(function() {
    ...
    if (pins_len > 0) {
        ...
        var tsvg_obj = document.getElementById("ngjspins");
        ...
        for (var i = 0; i < pins_len; i++) {
            if (pins_config.pins[i].shape === "circle") {
                ...
                svg_circle.setAttributeNS(null, "id", "ngjspins_" + i);
                tsvg_obj.appendChild(svg_circle);
                ngjsAddEvent(i);
                ...
                svg_rect.setAttributeNS(null, "id", "ngjspins_" + i);
                tsvg_obj.appendChild(svg_rect);
                ngjsAddEvent(i);
            }
        }
